...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--train_vr_input', type=str, default=None,
                                 help='First-stage VR predictions for moment training')
        self.parser.add_argument('--idx2video_path', type=str, default=None,
                                 help='TVR index-to-video mapping for moment training')
        ...
        self.parser.add_argument("--no_core_driver", action="store_false",
                                 help="hdf5 driver, new use `None` for python>3.8, default use `core` (load into RAM), if specified, use `None`")
        ...
        self.parser.add_argument("--train_zpath", type=str, default=None)
        ...
        self.parser.add_argument("--ctx_mode", type=str, choices=["video", "sub", "video_sub", "video_face_sub", "video_face", "tef",
                                                                  "video_tef", "sub_tef", "video_sub_tef", "video_face_sub_tef"],
        ...
        self.parser.add_argument("--knn_face_feat_path", type=str, default="")

        self.parser.add_argument("--portrait_feat_path", type=str, default="")
        ...
        self.parser.add_argument("--face_feat_size", type=int, help="feature dim for face feature")
        ...
        self.parser.add_argument("--train_moment", action="store_true", default=False)
    ...
    def parse(self):
        ...
        if "tef" in opt.ctx_mode and "video" in opt.ctx_mode:
            opt.vid_feat_size += 2
        if "tef" in opt.ctx_mode and "face" in opt.ctx_mode:
            opt.face_feat_size += 2
