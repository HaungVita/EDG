...
class BertSelfAttention(nn.Module):
    ...
    def forward(self, hidden_states, my_mask=None, attention_mask=None, head_mask=None, id=None):
        ...
        if my_mask != None:
            ...
            attention_scores[:, :, n_clips:2*n_clips, n_clips:2*n_clips] += subs_matrix.unsqueeze(0).unsqueeze(0)
...
class BertLayer(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask=None, head_mask=None, my_mask=None, id=None):
        attention_outputs = self.attention(
            hidden_states, attention_mask, head_mask, my_mask=my_mask, id=id)
    ...
    def forward(self, hidden_states, my_mask=None, attention_mask=None, head_mask=None, ):
        ...
        for i, layer_module in enumerate(self.layer):
            ...
            layer_outputs = layer_module(
                hidden_states, extended_attention_mask, None, my_mask=my_mask, id=i)
